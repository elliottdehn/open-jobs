...
ap.add_argument("--ats", default="ashby breezy comeet crelate dark dayforce eightfold gohire greenhouse icims jibe jobscore jobvite join lever oraclecloud paycom paylocity personio phenom pinpoint recruitee recruiterbox smartrecruiters softgarden successfactors taleo teamtailor ukg workable workday")
