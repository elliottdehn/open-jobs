...
ap.add_argument("--ats", default="ashby bamboohr breezy comeet cornerstone crelate dark dayforce eightfold gohire governmentjobs greenhouse icims jazzhr jibe jobscore jobvite join lever oraclecloud paycom paylocity personio phenom pinpoint recruitee recruiterbox smartrecruiters softgarden successfactors taleo teamtailor ukg usajobs workable workday")
