/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7d1d876357e25b0b6a90e04e3bf11b6)
...
interface __BaseEnv_Env {
	...
	ENRICH_DAY_USD: "50";
	EMBED_RATE_LIMIT: "10";
	EMBED_RATE_WINDOW_MS: "600000";
	IDEAS_MENTION: "U0AA4FAAC6L";
	OPENAI_KEY: string;
	R2_ACCOUNT_ID: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	BOARD: DurableObjectNamespace<import("./src/index").Board>;
	REGISTRY: DurableObjectNamespace<import("./src/index").Registry>;
	RATELIMIT: DurableObjectNamespace<import("./src/index").RateLimit>;
	BUDGET: DurableObjectNamespace<import("./src/index").Budget>;
	LOCK: DurableObjectNamespace<import("./src/index").Lock>;
	STATS: DurableObjectNamespace<import("./src/index").Stats>;
	DEDUPE: DurableObjectNamespace<import("./src/index").Dedupe>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Board" | "Registry" | "RateLimit" | "Budget" | "Lock" | "Stats" | "Dedupe";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOARD_ENRICH" | "EMBED" | "JOB_ENRICH" | "ENRICH_HOUR_USD" | "ENRICH_DAY_USD" | "EMBED_RATE_LIMIT" | "EMBED_RATE_WINDOW_MS" | "IDEAS_MENTION" | "OPENAI_KEY" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
